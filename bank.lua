...
cfg.banks = { -- liste af bankene
	...
	["Juvel Butikken"] = {
		position = { ['x'] = -631.01080322266, ['y'] = -229.25880432129, ['z'] = 38.057048797607 }, -- -631.01080322266,-229.25880432129,38.057048797607
		reward = math.random(200000,350000),
		nameofbank = "Juvel Butikken (Rockford Dr - Rockford Hills)",
		lastrobbed = 0
	},
